...
class CorePreferences {
	...
	*/
	...
	static var defaultDomain: String {
		get {
			let raw = Config.get().getString(section: "app", key: "default_domain", defaultString: "azzura.net.br")
			return safeString(raw, defaultValue: "azzura.net.br")
		}
		set {
	...
	static var disableMeetings: Bool {
		get {
			return Config.get().getBool(section: "ui", key: "disable_meetings_feature", defaultValue: true)
		}
		set {
